...
export const serversAtom = atom<ServerConfig[]>(
	DEFAULT_SERVER_SETTINGS.servers,
);

/** ID of the currently active server. */
export const activeServerIdAtom = atom<string>(
	DEFAULT_SERVER_SETTINGS.activeServerId,
);
