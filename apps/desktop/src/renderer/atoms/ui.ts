 ...
 *        `viewDiff("src/foo.ts")`
 */
export const viewFileInDiffPanelAtom = atom(
	null,
...
export const sessionDiffFamily = atomFamily((_sessionId: string) =>
	atom<FileDiff[]>([]),
);
...
export const diffFilterFamily = atomFamily((_sessionId: string) =>
